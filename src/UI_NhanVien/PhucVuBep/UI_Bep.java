...
public class UI_Bep extends JFrame {
    ...
    public UI_Bep() {
        setTitle("Quản lý danh sách bàn - Bếp");
        setSize(950, 560);
    ...
    private JPanel createMainPanel() {
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (col == 6) {
                    JOptionPane.showMessageDialog(null, "Chức năng dành cho Phục vụ!");
                }
            }
        });
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new UI_Bep().setVisible(true));
    }
}
