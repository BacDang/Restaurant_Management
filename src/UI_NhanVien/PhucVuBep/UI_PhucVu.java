...
public class UI_PhucVu extends JFrame {
    ...
    public UI_PhucVu() {
        setTitle("Quản lý danh sách bàn - Phục vụ");
        setSize(950, 560);
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (col == 6) {
                    ...
                    if (trangThaiBan.equals("Trống")) {
                        ...
                        DAOTable dao = new DAOTable();
                        String maDon = dao.getOrderId(tenBan);
                        UIThemMonVaoDon a = new UIThemMonVaoDon(maDon, tenBan, UI_PhucVu.this);
                        a.setVisible(true);
                    }
                }
            }
        ...
        model.addTableModelListener((TableModelEvent e) -> {
            ...
            if (col == 3) {
                ...
                if (oldValue.equals(newValue)) {
                    return;
                } else if (oldValue.equals("Chưa phục vụ")) {
    ...
    private JPanel createFilterRow() {
        ...
        fPhucVu = createFilterCombo(3, "Tất cả", "Chưa PV", "Đã gọi món", "Đã phục vụ");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new UI_PhucVu().setVisible(true));
    }
}
