...
public class UI_ThuNgan extends JFrame {
    ...
    public UI_ThuNgan() {
        setTitle("Quản lý danh sách bàn - Thu ngân");
        setSize(950, 560);
    ...
    private JLabel createTitle() {
        ...
        JButton xemDon = ButtonStyle.create("Xem ds Đơn ->", new Color(46, 204, 113));
        xemDon.setBounds(16, 16, 180, 30);
        title.add(xemDon);
        xemDon.addActionListener(l -> {
            new UIDanhSachOrder().setVisible(true);
            dispose();
        });
        return title;
    }
    ...
    private JPanel createMainPanel() {
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (col == 6) {
                    JOptionPane.showMessageDialog(table, "Chức năng dành riêng cho Phục vụ!");
                }
            }
        });
    ...
    private JPanel createFooter() {
        ...
        JButton dangXuatBtn = ButtonStyle.create("Đăng xuất", new Color(46, 204, 113));
        dangXuatBtn.addActionListener(l -> {
            new LoginForm().setVisible(true);
            dispose();
        });        
        footer.add(dangXuatBtn, BorderLayout.WEST);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new UI_ThuNgan().setVisible(true));
    }
}
